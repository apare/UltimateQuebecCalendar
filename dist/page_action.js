...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/page_action.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
function authenticated() {
    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        const selectedCalendar = yield Object(_localStorage__WEBPACK_IMPORTED_MODULE_2__["getCalendar"])();
        const calendars = yield Object(_googleApi__WEBPACK_IMPORTED_MODULE_1__["getCalendars"])();
        ...
        calendar.onchange = () => {
            document.body.classList.add("Loading");
            Object(_localStorage__WEBPACK_IMPORTED_MODULE_2__["setCalendar"])(calendar.value);
            chrome.tabs.query({
                currentWindow: true,
                active: true,
                ...
                if (tabs.length > 0) {
                    Object(_googleApi__WEBPACK_IMPORTED_MODULE_1__["getEvents"])(calendar.value)
                        .then(events => {
                        document.body.classList.remove("Loading");
                        tabs.forEach(tab => {
                            if (tab.id) {
                                chrome.tabs.executeScript(tab.id, {
                                    code: `UltimateQuebecCalendar.init(${Object(_utils__WEBPACK_IMPORTED_MODULE_3__["encodeParams"])(calendar.value, events)})`
                                });
                            }
                        });
                    })
...
function onError() {
    Object(_googleApi__WEBPACK_IMPORTED_MODULE_1__["authenticate"])().then(token => {
...
/******/ });
//# sourceMappingURL=page_action.js.map